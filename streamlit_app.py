...
with st.expander('Procurement and Tendering Options'):
    ...
    st.markdown('Please rate the following on a 0 to 5 scale, 1 being the least important and 5 being the most important. Please see below some project examples that \
